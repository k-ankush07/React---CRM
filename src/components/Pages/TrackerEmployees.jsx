...
export default function Employees() {
  ...
  const canViewHome =
    isAdmin || currentUserPermissions?.management?.manager_view === true;

  const canViewManagerTime =
    isAdmin || currentUserPermissions?.management?.manager_time === true;

  const canViewManagerDays =
    isAdmin || currentUserPermissions?.management?.manager_days === true;
    ...
    <RoleBasedLayout>
      <div className="relative h-[90.7vh] overflow-hidden">
        ...
        <div className="relative z-20 h-full overflow-y-auto p-6">
          ...
          {canViewManagerDays && (<div className="mt-8">
