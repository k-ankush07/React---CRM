...
import { useTotalContracts, useDeleteContract } from "../../Use-auth";
...
export default function Transactions() {
    ...
    const { mutate: deleteHoliday } = useDeleteContract();
    ...
    const filteredContracts = useMemo(() => {
        ...
        if (selectedClients.length) {
            filtered = filtered.filter((c) =>
                selectedClients.includes(c.client?.name)
            );
        }
    ...
    const handleDelete = (index) => {
        ...
        if (confirmDelete) {
            deleteHoliday(contractToDelete._id, {
                onSuccess: () => {
...
// import ManagementLayout from "../ManagementLayout";
// import { useCreateContracts, useTotalContracts, useDeleteContract } from "../../Use-auth";
// import { Button } from "../../ui/Button";
// import { Input } from "../../ui/Input";
// import SuccessToast from "../../ui/SucessToast";
// import DateRangePicker from "../../ui/DateRangePicker";
...
//           <div className="p-6 border border-gray-300 rounded-lg shadow-md bg-white space-y-6 mb-[20px]">
//             <h3 className="text-2xl font-semibold text-gray-800 mb-4">Create Contract</h3>
//             <form onSubmit={handleSubmit} className="space-y-4 text-[14px]">
//               <div className="flex flex-wrap gap-4">
//                 <div className="flex-1 flex flex-col">
//                   <label className="mb-1 font-medium">Date</label>
